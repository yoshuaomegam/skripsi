...
<div class="box">
    <div class="box-header with-border">
      ...
      <h3 class="box-title">Form Data Pembiayaan Tahun {{$data->tahun_perencanaan}}</h3>
      @if (count($errors) > 0)
...
@endif
    ...
    <div class="box-body">
                      {!! Form::open(array('route'=>['admin.pembiayaan.store', $data->id],'data-parsley-validate'=>'','files'=>'true','enctype'=>'multipart/form-data')) !!}                     
                        <label>Nama Pembiayaan</label>
                                        ...
                                        <br>
                                        <label>Dana Pembiayaan</label>
                                        <div class="input-group margin-bottom-sm">
                                                <span class="input-group-addon">Rp.</span>
                                    <input type="text" id="pembiayaan" name="pembiayaan" value="{{old('pembiayaan')}}" class="form-control perencanaan_list" required></td>
                                        </div>
                                        <br>
                                                                      ...
                                                                      <table class="table table-bordered" id="dynamic_field">  
                                                                          ...
                                                                          <td>Aksi</td>
                                                                          <tr>  
                                                                            <td><input type="file" name="file[]" placeholder="File" class="form-control" file="true" enctype="multipart/form-data"></td>  
