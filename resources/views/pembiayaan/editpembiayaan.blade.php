                    ...
                    <div class="box-header with-border"><h3 class="box-title" style="margin-left: 15px;margin-bottom: 5px;" >APBDesa Tahun {{$data->tahun_apbd}}</h3>
                        <td><a href="/admin/menupelaporan/{{$data->id}}/apbdesa/pembiayaan" class="btn btn-xs btn-success fa fa-plus"  title="tambah" style="position:absolute;right:20px;"></a></td>
                          ...
                          <div class="box-body">
                            ...
                            {!! Form::close() !!}  
                            <h3>Lampiran</h3>
                            <a href="#tambahmodal" class="btn btn-success" title="tambah" data-toggle="modal" data-target="#tambahmodal">Tambah Data Pembiayaan</a>
                            <br>
                            <br>
                        ...
                        <td>
                            {!! Form::model($detail,['route'=>['admin.pembiayaan.delete2', $data->id_pelaporan, $detail->id_pembiayaan, $detail->id],'method'=>'DELETE', 'id'=>'form']) !!}
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  {!! Form::model($detail,['route'=>['admin.pembiayaan.update2', $data->id_pelaporan,$data->id,$detail->id],'files'=>true]) !!} 
                          ...
                          @endforeach
                              ...
                              <div class="modal fade" id="tambahmodal" tabindex="-1" role="dialog" aria-labelledby="tambahmodalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h2 class="modal-title" id="tambahmodalLabel">Tambah File Pembiayaan</h2>
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                      </button>
                                    </div>
                                    <div class="modal-body">
                                        {!! Form::open(array('route'=>['admin.pembiayaan.store2','id' => $data->id_pelaporan,'id_pembiayaan'=>$data->id],'data-parsley-validate'=>'','files'=>true)) !!}
